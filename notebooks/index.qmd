...
- [GIF I](GIF_SN.ipynb): an implementation of the generalized integrate-and-fire neuron described in Schwalger, Deger, and Gerstner (2017) and [GIF II](GIF_CUBA.ipynb) demonstrates the usage of the model in a balanced network based on Vogels and Abbott (2005).
