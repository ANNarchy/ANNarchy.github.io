...
- [Neural Field](NeuralField.ipynb): a simple model using [neural fields](http://www.scholarpedia.org/article/Neural_fields). This is a very simple rate-coded model without learning.
- [BCM learning rule](BCM.ipynb): simple demonstration of the Intrator & Cooper BCM learning rule.
