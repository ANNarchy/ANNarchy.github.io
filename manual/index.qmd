...
```python
pop1 = net.create(name='pop1', geometry=100, neuron=LeakyIntegratorNeuron)

pop2 = net.create(name='pop2', geometry=100, neuron=LeakyIntegratorNeuron)
```
...
```python
proj.connect_all_to_all(weights = ann.Uniform(0.0, 1.0))
```
