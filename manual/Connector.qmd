...
1.  By using a [built-in connector method.](Connector.qmd#available-connector-methods)
2.  By using a [saved projection.](Connector.qmd#saved-connectivity)
3.  By loading [dense or sparse matrices.](Connector.qmd#from-connectivity-matrices)
4.  By defining a [custom connector method.](Connector.qmd#user-defined-patterns)

## Available connector methods

For further detailed information about these connectors, please refer to the library reference [Projections](/reference/Projection.qmd).
