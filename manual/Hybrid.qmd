...
Converting a rate-coded population to a spiking network is straightforward. The `PoissonPopulation` (see its [API](/reference/PoissonPopulation.qmd)) defines a population of spiking neurons emitting spikes following a Poisson distribution:
