...
For detailed examples of how to use the extension, refer to the examples [Basal Ganglia](/notebooks/BasalGanglia.ipynb) and [Bayesian optimization](/notebooks/BayesianOptimization.ipynb), which are available as notebooks in the folder `examples/tensorboard`.
...
![Structure of a neural network](img/tensorboard/tensorboard.png)
...
Refer to [Bayesian optimization](/notebooks/BayesianOptimization.ipynb) for an example using the `hyperopt` library.
