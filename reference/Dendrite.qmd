...
| `w`     | float  | synaptic weight (defalt: 0.0).  | `0.0`      |
| `delay` | float  | synaptic delay (default = dt)   | `0`        |
...
| Type                                     | Description                           |
|------------------------------------------|---------------------------------------|
| ANNarchy.core.Dendrite.IndividualSynapse | `IndividualSynapse` wrapper instance. |