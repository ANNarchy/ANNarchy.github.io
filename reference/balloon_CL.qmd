# balloon_CL { #ANNarchy.extensions.bold.PredefinedModels.balloon_CL }

`extensions.bold.PredefinedModels.balloon_CL(self, phi=1.0, kappa=1 / 1.54, gamma=1 / 2.46, E_0=0.34, tau=0.98, alpha=0.33, V_0=0.02, v_0=40.3, TE=40 / 1000.0, epsilon=1.43)`
