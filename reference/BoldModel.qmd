# BoldModel { #ANNarchy.extensions.bold.BoldModel.BoldModel }

`extensions.bold.BoldModel.BoldModel(self, parameters, equations, inputs, output=['BOLD'], name='Custom BOLD model', description='')`
...
|---------------|--------|----------------------------------------------------------------------------------|-----------------------|
| `parameters`  |        | parameters of the model and their initial value.                                 | _required_            |
| `equations`   |        | equations defining the temporal evolution of variables.                          | _required_            |
| `inputs`      |        | single variable or list of input signals (e.g. 'I_CBF' or ['I_CBF', 'I_CMRO2']). | _required_            |
