...
| `figure` | list \| numpy.numpy.array | a list or 1D numpy array of values.                                 | _required_ |
...
| Name   | Type                      | Description                         | Default    |
|--------|---------------------------|-------------------------------------|------------|
| `tag`  | name                      | name of the figure in tensorboard.  | _required_ |
| `hist` | list \| numpy.numpy.array | a list or 1D numpy array of values. | _required_ |
| `step` | int                       | time index.                         | `None`     |
...
| `img`      | numpy.numpy.array | array for the image.                                                           | _required_ |
| `step`     | int               | time index.                                                                    | `None`     |
...
|----------------------|-------------------|---------------------------------------------------------------------------------------------------------------------------------|------------|
| `tag`                | str               | name of the figure in tensorboard.                                                                                              | _required_ |
| `img`                | numpy.numpy.array | array for the images.                                                                                                           | _required_ |
| `step`               | int               | time index.                                                                                                                     | `None`     |
| `equalize`           | bool              | rescales the pixels between 0 and 1 using the min and max values of the array.                                                  | `False`    |
