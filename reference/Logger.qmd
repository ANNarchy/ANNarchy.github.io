...
| `figure` | list \| numpy.numpy.ndarray | a list or 1D numpy array of values.                                 | _required_ |
...
| `hist` | list \| numpy.numpy.ndarray | a list or 1D numpy array of values. | _required_ |
| `step` | int                         | time index.                         | `None`     |
...
|------------|---------------------|--------------------------------------------------------------------------------|------------|
| `tag`      | str                 | name of the figure in tensorboard.                                             | _required_ |
| `img`      | numpy.numpy.ndarray | array for the image.                                                           | _required_ |
| `step`     | int                 | time index.                                                                    | `None`     |
