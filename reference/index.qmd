...
| | |
| --- | --- |
| [Network](Network.qmd#ANNarchy.core.Network.Network) | A network is a collection of populations, projections and monitors that runs the simulation. |
