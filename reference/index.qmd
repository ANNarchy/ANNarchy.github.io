...
| | |
| --- | --- |
| [ANNtoSNNConverter](ANNtoSNNConverter.qmd#ANNarchy.extensions.ann_to_snn_conversion.ANNtoSNNConverter.ANNtoSNNConverter) | Converts a pre-trained Keras model into a spiking neural network.  |