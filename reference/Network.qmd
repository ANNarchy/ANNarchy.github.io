...
```python
core.Network.Network.callbacks_enabled()
```
...
```python
core.Network.Network.clear_all_callbacks()
```
...
```python
core.Network.Network.disable_callbacks()
```
...
```python
core.Network.Network.enable_callbacks()
```
