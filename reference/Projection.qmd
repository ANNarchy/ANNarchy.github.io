...
| disable_omp | bool              | Especially for small- and mid-scale sparse spiking networks, the parallelization of spike propagation is not scalable and disabled by default. It can be re-enabled by setting this parameter to `False`. | `True`     |
...
| [attributes](#ANNarchy.core.Projection.Projection.attributes) | List of attribute names (parameters + variables). |
| [functions](#ANNarchy.core.Projection.Projection.functions) | List of functions defined by the synapse model. |
...
| [post_ranks](#ANNarchy.core.Projection.Projection.post_ranks) | List of ranks of post-synaptic neurons that receive connections. Read-only. |
| [pre_ranks](#ANNarchy.core.Projection.Projection.pre_ranks) | List of lists of pre-synaptic ranks, for each post-synaptic neuron. Read-only. |
...
| Name | Description |
| --- | --- |
| [all_to_all](#ANNarchy.core.Projection.Projection.all_to_all) | all-to-all (fully-connected) connection pattern. |
| [fixed_probability](#ANNarchy.core.Projection.Projection.fixed_probability) | Probabilistic sparse connection pattern. |
| [one_to_one](#ANNarchy.core.Projection.Projection.one_to_one) | one-to-one connection pattern. |
| [fixed_number_pre](#ANNarchy.core.Projection.Projection.fixed_number_pre) | Connection pattern where each post-synaptic neuron receives a fixed number of pre-synaptic neurons. |
| [fixed_number_post](#ANNarchy.core.Projection.Projection.fixed_number_post) | Each pre-synaptic neuron randomly sends a fixed number of connections to the post-synaptic neurons. |
| [gaussian](#ANNarchy.core.Projection.Projection.gaussian) | Gaussian connection pattern. |
| [dog](#ANNarchy.core.Projection.Projection.dog) | Difference-Of-Gaussians connection pattern. |
| [from_function](#ANNarchy.core.Projection.Projection.from_function) | Connection pattern based on a user-defined function. |
| [from_matrix](#ANNarchy.core.Projection.Projection.from_matrix) | Builds a connection pattern according to a dense connectivity matrix. |
| [from_matrix_market](#ANNarchy.core.Projection.Projection.from_matrix_market) | Loads a weight matrix encoded in the Matrix Market format. This connector is intended for benchmarking purposes. |
| [from_sparse](#ANNarchy.core.Projection.Projection.from_sparse) | Builds a connectivity pattern using a Scipy sparse matrix for the weights and (optionally) delays. |
| [from_file](#ANNarchy.core.Projection.Projection.from_file) | Builds the connectivity matrix using data saved using `Projection.save_connectivity()` (not `save()`!). |
...
| [connectivity_matrix](#ANNarchy.core.Projection.Projection.connectivity_matrix) | Returns a dense connectivity matrix (2D Numpy array) representing the connectivity matrix between the pre- and post-populations. |
...
### all_to_all { #ANNarchy.core.Projection.Projection.all_to_all }
...
### fixed_probability { #ANNarchy.core.Projection.Projection.fixed_probability }
...
### one_to_one { #ANNarchy.core.Projection.Projection.one_to_one }
...
### fixed_number_pre { #ANNarchy.core.Projection.Projection.fixed_number_pre }
...
### fixed_number_post { #ANNarchy.core.Projection.Projection.fixed_number_post }
...
### gaussian { #ANNarchy.core.Projection.Projection.gaussian }
...
### dog { #ANNarchy.core.Projection.Projection.dog }
...
### from_function { #ANNarchy.core.Projection.Projection.from_function }
...
### from_matrix { #ANNarchy.core.Projection.Projection.from_matrix }
...
### from_matrix_market { #ANNarchy.core.Projection.Projection.from_matrix_market }
...
### from_sparse { #ANNarchy.core.Projection.Projection.from_sparse }
...
### from_file { #ANNarchy.core.Projection.Projection.from_file }
...
| Name   | Type   | Description                                                            | Default    |
|--------|--------|------------------------------------------------------------------------|------------|
| post   | int    | can be either the rank or the coordinates of the post-synaptic neuron. | _required_ |
...
| Name   | Type   | Description                       | Default    |
|--------|--------|-----------------------------------|------------|
| pre    | int    | rank of the pre-synaptic neuron.  | _required_ |
| post   | int    | rank of the post-synaptic neuron. | _required_ |
