...
`core.Population.Population(self, geometry, neuron, name=None, stop_condition=None, storage_order='post_to_pre', copied=False)`
...
| `neuron`         | ANNarchy.core.Neuron.Neuron | `Neuron`instance. It can be user-defined or a built-in model.                              | _required_ |
...
| [name](#ANNarchy.core.Population.Population.name) | Name of the population |
...
| [get](#ANNarchy.core.Population.Population.get) | Returns the value of neural variables and parameters. |
...
| [set](#ANNarchy.core.Population.Population.set) | Sets the value of neural variables and parameters. |
...
| Type                                  | Description                |
|---------------------------------------|----------------------------|
| ANNarchy.core.Neuron.IndividualNeuron | IndividualNeuron instance. |
