...
| Name           | Type   | Description                                                                                                                                                                                                                                                                     | Default      |
|----------------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| `filename`     |        | stored model as a .h5 file.                                                                                                                                                                                                                                                     | _required_   |
| `directory`    |        | sub-directory where the generated code should be stored (default: "annarchy")                                                                                                                                                                                                   | `'annarchy'` |
| `scale_factor` |        | allows a fine-grained control of the weight scale factor. By default (None), with each layer-depth the factor increases by one. If a scalar value is provided the same value is used for each layer. Otherwise a list can be provided to assign the scale factors individually. | `None`       |
| `show_info`    |        | whether the network structure should be printed on console (default: True)                                                                                                                                                                                                      | `True`       |
