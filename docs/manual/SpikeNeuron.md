...
As for rate-coded neurons, the parameters are defined in the
...
The `refractory` argument can be a floating value or the name of a
...
Here, a leaky integrator on f is needed to 1) smooth the firing rate and
