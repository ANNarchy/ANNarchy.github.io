...
Each time a pre-synaptic spike occurs, the post-synaptic conductance is
...
-   Every time a pre-synaptic spike arrives at the synapse
...
1.  Pre-synaptic events, defined by `pre_spike` and triggered after each
